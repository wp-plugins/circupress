...
CircuPress Template: On Demand Single Column V2
Width: 600
            ...
            <table width="600" align="center" border="0" cellpadding="0" cellspacing="0" class="container">
              <tr>
                <td>
                    ...
                    <table border="0" width="220" align="right" cellpadding="0" cellspacing="0" class="media">
                        <tr>
                          <td><a href="%%ONLINE%%" target="_blank" style="color:#323f4e; text-decoration:none; font-family:'Open Sans', Source Sans Pro, arial, verdana, tahoma; font-size:14px;">View Online</a></td>
                          <td width="10">&nbsp;</td>
                          <td width="35"><a href="%%FACEBOOK%%" target="_blank"><img src="http://plugin.circupress.com/wp-content/uploads/2015/04/facebook.png" alt="facebook" style="border:none;" /></a></td>
                          <td width="10">&nbsp;</td>
                          <td width="35"><a href="%%TWITTER%%" target="_blank"><img src="http://plugin.circupress.com/wp-content/uploads/2015/04/twitter.png" alt="twitter" style="border:none;" /></a></td>
                          <td width="10">&nbsp;</td>
                          <td width="35"><a href="%%RSS%%" target="_blank"><img src="http://plugin.circupress.com/wp-content/uploads/2015/04/rss.png" alt="google" style="border:none;" /></a></td>
                        </tr>
                    </table>
...
<!-- MAIN HEADER IMAGE SPACE 600 X 250 PIXELS -->
        ...
        <tr>
             <td align="left" valign="top" style="font-family:'Open Sans', Source Sans Pro, arial, verdana, tahoma; font-size:20px; font-weight:600; color:#323f4e;">In Case You Missed Our Latest News:</td>
        </tr>
        <tr>
          	<td height="50" style="border-bottom:1px solid #ddd;" class="hrule">&nbsp;</td>
        </tr>
