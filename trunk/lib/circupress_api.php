...
### Set Global Options
$cp_options['api_url'] = 'https://www.circupress.com/api/api.php';
...
function wpcp_update_list_subscriber($api_key, $cp_email_address, $cp_list_id, $cp_subscriber_id, $cp_subscriber_status = '1', $cp_first_name = '', $cp_last_name = '', $cp_address = '', $cp_city = '', $cp_state = '', $cp_zip = '', $cp_phone = '', $cp_website = '', $cp_company_name = '', $cp_mobile = ''  ){
